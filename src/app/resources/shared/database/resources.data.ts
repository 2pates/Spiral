...
export class ResourcesData implements InMemoryDbService {
  ...
  private resources: IResource[] = [
    ...
    {
      resourceId: 2,
      title: 'La Cagette des Gones',
      body: 'La Cagette des Gones est une boutique spécialisée dans la vente de produits bio, équitables et écologiques en plein cœur de la Croix-Rousse. La Cagette, c’est avant tout des valeurs qui nous tiennent à cœur : nous pensons que c’est en proposant des produits sains, bio et bons que nous réduisons notre impact environnemental. Pour nous, promouvoir une agriculture biologique et un commerce équitable, c’est mettre au cœur de nos préoccupations la terre et l’humain en recréant du lien avec nos agriculteurs, en proposant une alimentation bio et saine, en favorisant les produits locaux et régionaux. ',
    ...
    },
    {
      resourceId: 3,
      title: 'Emmaus',
      body: 'Depuis plus de 70 ans, le mouvement Emmaüs milite pour un monde plus juste dans lequel chacun retrouve sa dignité et sa place. Laboratoire d’innovation sociale, il invente au quotidien des solutions pour lutter contre l’exclusion.',
      link: 'https://emmaus-france.org',
      imageUrl:
        'https://emmaus-france.org/wp-content/themes/emmausfr/assets/img/logo-emmaus-france.svg',
      tags: ['reutiliser', 'substituer', 'vestimentaire', 'achats'],
    },
    {
      resourceId: 4,
      title: 'Bring !',
    ...
    },
    {
      resourceId: 5,
      title: 'Flat white',
      body: "Le flat white est une boisson à base de café composée d'expresso et de micro mousse. Il est semblable au latte, mais servi en moindre quantité avec moins de micro mousse, lui donnant ainsi une plus grande proportion de café par rapport au lait, qui est lui-même d'une consistance plus légère et veloutée.",
    ...
    {
      resourceId: 7,
      title: "Cependant, titre Sept n'a rien à envier au titre Deux",
      body: 'Texte pour la case Sept.',
      link: 'https://www.wikipedia.fr/',
      imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Two_red_dice_01.svg/330px-Two_red_dice_01.svg.png',
      tags: ['random'],
    },
    {
      resourceId: 8,
      title:
        'Titre Huit est vraiment vraiment très très long car il faut tester les limites',
      body:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et' +
        'dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut' +
        'aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum' +
    ...
    {
      resourceId: 10,
      title: 'Mais le titre Deux est vachement plus long !',
      body:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et' +
        'dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut' +
        'aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum' +
    ...
    {
      resourceId: 12,
      title: "C'est un titre Quatre moyen mais vrai",
      body:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et' +
        'dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut' +
        'aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum' +
    ...
    {
      resourceId: 13,
      title: 'Titre Cinq plus long que Six !',
      body:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et' +
        'dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut' +
        'aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum' +
  ...
  genId(): number {
    return this.resources.length > 0
      ? Math.max(...this.resources.map((resource) => resource.resourceId)) + 1
      : 1;
  }
}
